 ...
 * 
 * nota: Se corrigio la librería para que funcione en cakephpa 2.x y además para que funcione en php 5.4+ 
 * muchas funciones de oci8 son obsoletas.
 * Seller was corrected to work in 2.x cakephpa addition to work in php 5.4 +
 * Oci8 many functions are obsolete.
 *
